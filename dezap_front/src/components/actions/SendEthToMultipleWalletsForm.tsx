...
const SendEthToMultipleWalletsForm: React.FC<{ onClose: () => void, onSubmit: (data: any) => void }> = ({ onClose, onSubmit }) => {
  return (
    <BaseForm title="Send ETH to Multiple Wallets" onSubmit={onSubmit} onClose={onClose}>
